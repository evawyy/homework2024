...
\begin{problem}\label{pro:3.39}
  ...
  则
  \begin{enumerate}
    \item \(\mu_1 \vee \mu_2 \)是满足\(\nu \geq \mu_i,i=1,2 \)的最小符号测度；
    \item \(\mu_1 \wedge \mu_2 \)是满足\(\nu \leq \mu_i,i=1,2 \)的最大符号测度。
  \end{enumerate}
\end{problem}
\begin{solution}
  对\(\mu_1-\mu_{2} \)进行 Hahn 分解得到\(D,D^c \)，使\((\mu_1-\mu_{2})^+(A)=\mu_1(A \cap D)-\mu_2(A \cap D) \geq 0\)。
  则\((\mu_2-\mu_{1})^+(A)=(\mu_1-\mu_{2})^-(A)=\mu_2(A \setminus D)-\mu_1(A \setminus D) \)。
  那么显然\((\mu_1-\mu_{2})^+\geq \mu_1 - \mu_2 ,(\mu_2-\mu_{1})^+ \geq \mu_2 - \mu_1 \)。

  \begin{enumerate}
    \item 对于任何的\(A \)，有\(\mu_1 \vee \mu_2(A)= \mu_1(A) + (\mu_2-\mu_1)^+(A) \geq \mu_1(A) + \max\{0,\mu_2(A)-\mu_1(A)\}=\max\{\mu_1(A),\mu_2(A)\}\)；
      下证设\(\nu\)满足\(\nu \geq \mu_i \)，\(\nu \geq \mu_1 \vee \mu_2 \)。反设不成立，则存在\(A \)使\(\nu(A)<\mu_1 \vee \mu_2(A) \)，
      则\(\nu(A \cap D)<\mu_1 \vee \mu_2(A \cap D) \)或\(\nu(A \setminus D) < \mu_1 \vee \mu_2(A \setminus D)  \)。
      而\(\mu_1 \vee \mu_2(A \cap D)=\mu_1(A \cap D) + (\mu_2 - \mu_{1})^+ (A \cap D)=\mu_1(A \cap D), \mu_1 \vee \mu_2 (A \setminus D)=\mu_1(A \setminus D) + (\mu_2-\mu_{1})^{+}(A \setminus D)=\mu_1(A \setminus D) + \mu_2(A \setminus D)-\mu_1(A \setminus D)=\mu_2(A \setminus D)\).
      故\(\nu(A \cap D) < \mu_1(A \cap D)\)或\( \nu(A \setminus D) <\mu_2(A\setminus D) \).
      均与\(\nu \geq \mu_1,\mu_{2} \)矛盾！故\(\nu \geq \mu_1 \vee \mu_{2} \)。
    \item  同理\(\mu_1\wedge \mu_2(A)=\mu_1(A)-(\mu_1-\mu_{2})^-(A) \leq \mu_1(A)-\max\{0,\mu_1(A)-\mu_2(A)\}=\min\{\mu_1(A),\mu_2(A)\} \)。
      下证设\(\nu\)满足\(\nu \leq \mu_i \)，\(\nu \leq \mu_1 \vee \mu_2 \)。反设不成立，则存在\(A \)使\(\nu(A)>\mu_1 \wedge \mu_2(A) \)，
      则\(\nu(A \cap D)<\mu_1 \wedge \mu_2(A \cap D) \) 或\(\nu(A \setminus D) < \mu_1 \wedge \mu_2(A \setminus D)  \)。
      而\(\mu_1 \wedge \mu_2(A \cap D)=\mu_1(A \cap D) - (\mu_1 - \mu_{2})^+ (A \cap D)=\mu_1(A \cap D)-\mu_1(A \cap D) + \mu_2(A \cap D)=\mu_2(A \cap D), \mu_1 \wedge \mu_2 (A \setminus D)=\mu_1(A \setminus D) - (\mu_1-\mu_{2})^{+}(A \setminus D)=\mu_1(A \setminus D) =\mu_1(A \setminus D)\).
...
\begin{solution}
  ...
  又由于\(\{x \in \Omega:\mu(\{x\}) >0\} = \bigcup_{n = 1}^{\infty}A_n \)，而每个\(A_n \)有限，故\(\{x \in \Omega:\mu(\{x\})>0\} \)至多可数。
\end{solution}
...
\begin{solution}
  ...
  由转移测度的定义知\(\int_{A_{3}} 1 \lambda(\omega_2,\d \omega_{3})=\lambda(\omega_2,A_3) \)关于\(\mathcal{A}_2  \)可测，又显然\(\mathbbm{1}_{A_{1}}(\omega_{1}) \)关于\(\mathcal{A}_1 \)可测，
  故\(\int_{\Omega_{3}} \mathbbm{1}_{A_{1} \times A_{3}}(\omega_1,\omega_{3}) \lambda(\omega_2,\d \omega_{3}) \)关于\(\mathcal{A}_1 \times \mathcal{A}_2 \)可测。于是\(\mathbbm{1}_{A_{1} \times A_{3}} \in L \)。
  而\(\mathcal{A}_1 \times \mathcal{A}_3 \)为\(\pi \)-系，故由函数类的单调类定理可知所有\(\mathcal{A}_1 \times \mathcal{A}_{3} \)可测函数均在\(L \)中。
\end{solution}
...
\begin{solution}
  \begin{enumerate}
    \item 先证对固定的\(i \)，\(\lambda(i,\cdot) \)是概率。由于\(\mu_{ij}(A) = \mathbbm{1}_{j \in A} p_{ij} \geq 0\)且显然\(\sigma \)可加，
      故为测度。从而\(\lambda(i,A) = \sum_{j}\mu_{ij}(A) \)为测度。又\(\lambda(i,\Omega) = \sum_{j}p_{ij} = 1 \)，故为概率。
    \item 再证对固定的\(A \)，\(\lambda(\cdot,A) \)可测。在可数离散空间上显然所有函数都可测。
  \end{enumerate}
  综上，\(\lambda \)是转移概率。
\end{solution}
...
\begin{solution}
  只需证明\(\nu_1\times \nu_2(A) = \int_{A} \frac{\d \nu_{1}}{\d \mu_{1}}(\omega_{1}) \frac{\d \nu_{2}}{ \d \mu_{2}}(\omega_{2}) \d(\mu_1 \times \mu_{2}),\forall A \in \mathcal{A}_1 \times \mathcal{A}_2\).
  由测度扩张的唯一性，只需验证对于\(A_{1} \times A_{2} \in \mathcal{A}_1 \times \mathcal{A}_{2} \)，有\(\nu_1 \times \nu_{2}(A_{1} \times A_{2}) = \int_{A_1 \times A_{2}} \frac{\d \nu_{1}}{\d \mu_{1}}(\omega_{1}) \frac{\d \nu_{2}}{\d \mu_{2}}(\omega_{2}) \d \mu_1 \times \mu_{2} \)即可。
  显然有
  \(\nu_1 \times \nu_2(A_{1} \times A_{2}) = \nu_1 (A_{1}) \nu_2(A_{2}) = \int_{\Omega_{1}} \mathbbm{1}_{A_{1} }(\omega_{1})\frac{\d \nu_{1}}{\d \mu_{1}}(\omega_{1}) \d \mu_{1} \cdot \int_{\Omega_{2}} \mathbbm{1}_{A_{2}}(\omega_2 )\frac{\d \nu_{2}}{\d \mu_{2}}(\omega_{2}) \d \mu_{2}
  = \int_{\Omega_1 \times \Omega_{2}} \mathbbm{1}_{A_{1} \times A_{2}}(\omega_1,\omega_{2}) \frac{\d \nu_{1}}{\d \mu_{1}}(\omega_{1}) \frac{\d \nu_{2}}{\d \mu_{2}}(\omega_{2}) \d \mu_1 \times \mu_{2} =\int_{A_{1} \times A_{2}} \frac{\d \nu_{1}}{\d \mu_{1}}(\omega_{1}) \frac{\d \nu_{2}}{\d \mu_{2}}(\omega_{2}) \d \mu_1 \times \mu_2 \)。
\end{solution}
...
\begin{problem}\label{pro:4.10}
  ...
  证明\(\prod_{t \in T}\mathcal{A}_t = \sigma\left(\bigcup_{t \in T} J_t^{-1}(\mathcal{C}_t)\right) \)，其中\(J_t:\prod_{i \in T} \Omega_i\ni \omega \mapsto \omega_t \in \Omega_t \)。
\end{problem}
\begin{solution}
  显然有\(\prod_{t \in T}\mathcal{A}_t \supset \sigma\left(\bigcup_{t \in T} J_t^{-1}(\mathcal{C}_t)\right) \)。
  \begin{enumerate}
    \item 先证\(T \)为可数集，\(\prod_{t \in T}\mathcal{A}_t = \sigma\left(\bigcup_{t \in T} J_t^{-1}(\mathcal{C}_t)\right) \)。\\
      只需证\( \sigma\left(\bigcup_{t \in T} J_t^{-1}(\mathcal{C}_t)\right) \)包含所有有限维柱集。\(T_0 \subset T \)为有限集。
      ...
      由\(\sigma(\mathcal{C}_t) = \mathcal{A}_t \)及\(A_t \in \mathcal{A}_t \)，故\(J_t^{-1}(A_t) \in J_t^{-1}(\sigma(\mathcal{C}_t))=\sigma(J_t^{-1}(\mathcal{C}_t))  \)。故\( \sigma\left(\bigcup_{t \in T} J_t^{-1}(\mathcal{C}_t)\right) \)包含所有有限维柱集，
      从而\(\prod_{t \in T}\mathcal{A}_t = \sigma\left(\bigcup_{t \in T} J_t^{-1}(\mathcal{C}_t)\right) \)。
    \item 再证\(T \)为不可数集，\(\prod_{t \in T}\mathcal{A}_t = \sigma\left(\bigcup_{t \in T} J_t^{-1}(\mathcal{C}_t)\right) \)。\\
      只需证\( \sigma\left(\bigcup_{t \in T} J_t^{-1}(\mathcal{C}_t)\right) \)包含所有可数维柱集。\(T_0 \subset T \)为可数集。
      由于上述证明可知，\(\prod_{t \in T_0}A_t \times \prod_{t \in T \setminus T_{0}} \Omega_t \subset \sigma(\bigcup_{t \in T} J_t^{-1} (\mathcal{C}_t))\)。
      从而\(\prod_{t \in T}\mathcal{A}_t = \sigma\left(\bigcup_{t \in T} J_t^{-1}(\mathcal{C}_t)\right) \)。
  \end{enumerate}
\end{solution}
\end{document}
