...
\begin{itemize}
  ...
  \item paradigm 范式
  \item integrated appoarach 整合方法
\end{itemize}
\section{10/10}
翻译的语法基础
\begin{itemize}
  \item 名词是单数，但是形式上是复数：crossroads，如 at a crossroads
  \item polysemy 一词多义，名词单复数含义不一样：spirit sing. 精神； pl. 烈酒
  \item future sing. 未来； pl. 期货 oil futures
  \item security sing. 安全；pl. 证券
  \item research on significance of leadership；有关领导力意义的研究
\end{itemize}
翻译的知识
\begin{itemize}
    % \item the Civil War 英国革命；美国内战
  \item 杂家：a jack of all trades
  \item BRI = Belt and Road Initiative 一带一路
  ...
  \item 讲好中国故事 tell the true story of China
  \item status quo 现状
  \item reproduce 复现
  \item diamonds cut diamonds 强中自有强中手
  \item improvise 临时，将就；即兴
